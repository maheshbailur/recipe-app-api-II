...
class RecipeSerializer(serializers.ModelSerializer):
    ...
    def _get_or_create_tags(self, tags, recipe):
        ...
        for tag in tags:
            """For this user if tag not exists then create in Tag table
            if tag exist then just get that tag from db,
            Then save the unique tag object in recipe tag field"""
    ...
    def create(self, validated_data):
        ...
        """create the recipe (without tags, later will add this field)"""
